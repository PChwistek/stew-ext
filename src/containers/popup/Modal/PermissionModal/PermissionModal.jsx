...
function getRightLinkPermissions(selectedRecipe) {
  ...
  if(selectedRecipe) {
    const isAny = selectedRecipe.linkPermissions && selectedRecipe.linkPermissions.findIndex(item => item === 'any') > -1
    const isOrg = selectedRecipe.linkPermissions && selectedRecipe.linkPermissions.findIndex(item => item === 'org') > -1
